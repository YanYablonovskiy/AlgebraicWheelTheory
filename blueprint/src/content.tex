...
Given a wheel $W$, certain sub-sets form familiar structures. Consider the subset:
\[
...
\end{remark}
Firstly,
\begin{definition}[\textbf{$\mathcal R_{W}$ is a commutative magma in * and +}]
  \lean{Wheel.instCommMagma,Wheel.instAddCommMagma}
  \leanok
...
\begin{definition}[\textbf{$\mathcal R_{W}$ is a commutative monoid in * and +}]
  \lean{Wheel.instCommMonoid,Wheel.instAddCommMonoid}
  \leanok
...
\begin{definition}[\textbf{$\mathcal R_{W}$ is a semiring in * and +}]
